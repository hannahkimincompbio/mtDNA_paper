...
mtDNA_BUSTED_2x2_2_3_2020<- mtDNA_BUSTED_2x2_2_3_2020 %>%  mutate(., NS.rates = 3,
          S.rates = 3,
...
```
```{r}
mtDNA_3x3 <- full_join(mtDNA_BUSTED_2x2_2_3_2020, mtDNA_SRV_2x2_2_3_2020, by = c("FILE", "Sites", "Sequences", "gene", "order", "NS.rates","S.rates"), suffix = c(".busted",".srv"))
